...
if __name__ == "__main__":
    ...
    mean = np.load(pjoin(opt.data_root, 'Mean_abs.npy'))
    std = np.load(pjoin(opt.data_root, 'Std_abs.npy'))
...
# python train_vq.py --dataset_name t2m --batch_size 256 --name abs_VQVAE_dp1_b256 --gpu_id 2