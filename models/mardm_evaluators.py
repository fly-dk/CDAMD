...
def build_evaluators(dim_pose, dataset_name, dim_movement_enc_hidden, dim_movement_latent, dim_word, dim_pos_ohot, dim_text_hidden,
    ...
    checkpoint = torch.load(os.path.join('/checkpoints', dataset_name, 'text_mot_match_absolute/text_mot_match', 'model', 'finest.tar'),
                            map_location=device)
    checkpoint_clip = torch.load(os.path.join('/checkpoints', dataset_name, 'text_mot_match_absolute/text_mot_match_clip', 'finest.tar'),
                            map_location=device)
