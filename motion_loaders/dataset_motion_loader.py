...
def get_dataset_motion_loader(opt_path, batch_size, fname, device, drop_last=True, shuffle=True):
    ...
    if opt.dataset_name == 't2m' or opt.dataset_name == 'kit':
        ...
        dataloader = DataLoader(dataset, batch_size=batch_size, num_workers=4, drop_last=drop_last,
